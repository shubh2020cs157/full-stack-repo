      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center">
          <h2 className="text-4xl font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
            <span className="block">Google OAuth</span>
            <span className="block text-blue-600">with Next.js</span>
          </h2>
          <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
            A complete implementation of Google OAuth authentication using
            NextAuth.js, TypeScript, and Next.js 14 with App Router.
          </p>
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-sm text-gray-500">
                    Full type safety with Next.js 14
                  </p>
                </div>
              </div>
            </div>
